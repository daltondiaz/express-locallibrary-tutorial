    ...
    if(errors){
      ...
      .exec(function(err,books){
        ...
        res.render('bookinstance_form',{title: 'Create BookInstance',
          book_list: books, selected_book: book._id,
          erros: erros, bookinstance: bookinstance});
      });
      return ;
    }else{
...
exports.bookinstance_delete_post = function(req, res, next) {
    req.checkBody('bkinstanceid','Book Instance must exist').notEmpty();

    BookInstance.findByIdAndRemove(req.body.bkinstanceid,
